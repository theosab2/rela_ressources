...
export default function Inscription(){
        ...
        'http://10.176.131.75:3000/auth/register', {
            method: 'POST',
            headers: {
        ...
        <div className={style.InscriptionContainer}>
            <div className={style.InscriptionSubContainer}>
                ...
                <form className={style.FormInscription}>
                    <label className={style.LabelInscription}>Nom d'utilisateurs :</label>
                    <input id="pseudo" name="pseudo" type="text" 
                    className={style.InputInscrption} required 
                    ...
                    <input id="confMdp" name="confMdp" type="password" 
                    className={style.InputInscrption} required />     
