  ...
  return (
    <ScrollView contentContainerStyles={styles.container}>
      ...
      <Input
        ...
        leftIcon={<Icon name="user" type="evilicon" color="#517fa4" />}
      />
      <Input
        placeholder="Email"
        containerStyle={{width: '100%'}}
      ...
      <Input
        ...
        defaultValue={phone}
        leftIcon={<Icon name="bell" type="evilicon" color="#517fa4" />}
      />
      <Input
      ...
      <Input
        ...
        defaultValue={ville}
        leftIcon={<Icon name="location" type="evilicon" color="#517fa4" />}
      />
      <Input
